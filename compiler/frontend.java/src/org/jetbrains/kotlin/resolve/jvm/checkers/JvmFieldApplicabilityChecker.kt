...
class JvmFieldApplicabilityChecker : DeclarationChecker {
    ...
    internal enum class Problem(val errorMessage: String) {
        ...
        NOT_PUBLIC_VAL_WITH_JVMFIELD_OR_CONST("JvmField could be applied only if all interface companion properties are 'public final val' with '@JvmField' annotation or const modifier"),
